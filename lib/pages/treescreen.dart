...
class TreeScreen extends StatefulWidget {
  ...
  final Function(int) onScoreUpdated; // Callback function
  //const TreeScreen({Key? key, required this.options}) : super(key: key);

  const TreeScreen({
    Key? key,
    required this.options,
    required this.onScoreUpdated, // Pass the callback
  }) : super(key: key);
  @override
...
//class TreeScreen extends StatelessWidget{
  ...
  int nodeValue = 0;
  int score = 0; //this value will be returned to the main lesson page to keep track of score
  bool hasCheckedAnswers = false;//to track text of the button
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ElevatedButton(
            onPressed: hasCheckedAnswers
                ? returnScore // After first click, return score
                : checkAnswers, // On first click, check answers
            child: Text(hasCheckedAnswers ? "Continue" : "Check Answers"), // Change text dynamically
          ),
        ],
      ),
